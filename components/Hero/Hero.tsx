      ...
      <div className={css.container}>
        <div className={css.contentGroup}>
          <div className={css.content}>
            <h1 className={css.title}>Знайди свій стиль з Clothica вже сьогодні!</h1>
            <p className={css.description}>
              Clothica — це місце, де комфорт поєднується зі стилем. Ми створюємо базовий одяг, який
              легко комбінується та підходить для будь-якої нагоди. Обирай речі, що підкреслять твою
              індивідуальність і завжди будуть актуальними.
            </p>
          </div>
          <div className={css.actions}>
            <a href="#popular_goods" className={css.links}>
              До товарів
            </a>
            <a href="#PopularCategories" className={`${css.links} ${css.linksCategory}`}>
              Дослідити категорії
            </a>
          </div>
        </div>
        <picture>
          ...
          <source media="(min-width: 768px) and (max-width: 1439px)" srcSet={TabletImg.src} />
